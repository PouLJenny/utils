 ...
 * 中国农历工具
 * @author peng
 * @date 2018/5/21 19:37
 */
public class ChineseCalendarUtils {

    private ChineseCalendarUtils(){}
    ...
    private static String[] read(String fileName) {
        ...
        try {
            br = new BufferedReader(
                    new InputStreamReader(ChineseCalendarUtils.class.getClassLoader().getResourceAsStream("calendar/config.cal")));
            String every = null;
    ...
    public static void main(String[] args) {
        String date = getDate("2020-01-02");
