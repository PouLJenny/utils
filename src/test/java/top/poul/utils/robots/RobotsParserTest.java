...
public class RobotsParserTest {
    ...
    public void testBaidu() throws Exception {
        RobotsParser yuiYeBot = new RobotsParser("YuiYeBot");
        yuiYeBot.connect("https://www.baidu.com");

        List<String> disallowedPaths = yuiYeBot.getDisallowedPaths();
        if (CollectionUtils.isNotEmpty(disallowedPaths)) {
            disallowedPaths.forEach(v->{
